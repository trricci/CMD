    ...
    def create_database(self):
        ...
        self.cursor.executescript('''
            CREATE TABLE IF NOT EXISTS ESTUDOS(
                ...
                RAMAL_AEREO_SUBTERRANEO                 TEXT,
                DEMANDA_EXISTENTE                       REAL,
                DEMANDA_TOTAL_SOLICITADA                REAL,
                DSS_FILE_PATH                           TEXT,
                RAMAL_EXISTENTE                         TEXT,
                RAMAL_MODIFICADO                        BOOL,
                DSS_ENTRADA_STRING                      TEXT,
                DSS_EDITADA_STRING                      TEXT,
                MES_ANO_ESTUDO                          TEXT,
                PATAMAR_ESTUDO                          INTEGER,
                ...
                INDICE_DESBALANCEAMENTO_SUPERIOR        REAL,
                INDICE_DESBALANCEAMENTO_INFERIOR        REAL,
                QUEDA_TENSAO                            REAL,
        ...
        with self.conn:
            self.cursor.execute(f'''
                INSERT INTO ESTUDOS VALUES (
                    ...
                    '{cmd.ramal_aereo_subterraneo}',
                    '{cmd.DE}',
                    '{cmd.DTS}',
                    '{cmd.dssfile}',
                    '{cmd.ramal_existente}',
                    '{cmd.ramal_modificado}',
                    '{cmd.CPFL_circuit_string}',
                    '{cmd.circuit_string}',
                    '{cmd.mes_ano}',
                    '{cmd.patamar}',
                    '{cmd.delta_wye}',
